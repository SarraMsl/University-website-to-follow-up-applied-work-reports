      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Collective work</li>
          </ol>
          <h6 class="font-weight-bolder mb-0"> Collective work</h6>
        </nav>
...
$var = $_SESSION["user_id"];
        $sql=$conn->query("select * from `collective_work` where `Type`='$var' ");
        while($row=$sql->fetch_array()){
          ?>
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                          ...
                          <span class="mb-2 text-xs">Full Name of member two: <span class="text-dark font-weight-bold ms-sm-2"><?php echo $row['member_02']; ?></span></span>
...
Pdf Task Report : <span class="text-dark ms-sm-2 font-weight-bold">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                          <div class="card card-plain">
                            <div class="card-header">
                              <h4 class="font-weight-bolder">Add Type of Collective work</h4>
                              <p class="mb-0">Enter type of Collective work </p>
                            </div>
                            <div class="card-body">
                              <form role="form" method="post" action="back_colective.php"  enctype="multipart/form-data">
                      
                              <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Full Name of member 01</label>
                                  <input type="text" name="member_01" class="form-control">
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Full Name of member 02</label>
                                  <input type="text" name="member_02" class="form-control">
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Full Name of member 03</label>
                                  <input type="text" name="member_03" class="form-control">
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Full Name of member 04</label>
                                  <input type="text" name="member_04" class="form-control">
                                </div>
                              
                                <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Status of task</label>
                                  <input type="text" name="Status_of_task" class="form-control">
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Subject of task</label>
                                  <input type="text" name="Subject_of_task" class="form-control">
                                </div>
                                        <div class="input-group input-group-outline mb-3">
                                <label class="form-label">Task Summary</label>
                                <textarea type="text" name="Task_Summary" class="form-control " ></textarea>
                              </div>
                              <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">file of Task</label>
