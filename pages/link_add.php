      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Link</li>
          </ol>
          <h6 class="font-weight-bolder mb-0"> Add Link</h6>
        </nav>
...
">
    ...
    if (!$conn) {
      echo "Connection failed!";
        ...
        $sql=$conn->query("select * from `link` where `Type`='$var' ");
        while($row=$sql->fetch_array()){
          ?>
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                          <div class="card card-plain">
                            <div class="card-header">
                              <h4 class="font-weight-bolder">Add link</h4>
                              <p class="mb-0">Enter detils of link </p>
                            </div>
                            <div class="card-body">
                              <form role="form" method="post" action="back_link_add.php">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                  ...
                                  <input type="text" name="Subject_of_work" class="form-control">
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">Name of link</label>
                                  <input type="text" name="Name_of_link" class="form-control">
                                </div>   
                                   <div class="input-group input-group-outline mb-3">
