...
include("conn.php");
        ...
        $sql=$conn->query("select * from `note_01` ");
        while($row=$sql->fetch_array()){
          ?>
          ...
          <div class="card h-100 mb-4" >
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                          <div class="card card-plain">
                            <div class="card-header">
                              <h4 class="font-weight-bolder">Add Note Colective</h4>
                              <p class="mb-0">Enter ditils of Note </p>
                            </div>
                            <div class="card-body">
                              <form role="form" method="post" action="back_note_01.php">
                              <div class="input-group input-group-outline mb-3">
                                ...
                                <select type="text" name="tto_01" class="form-control">
                                <option> </option>";
            ...
            ?>
                            ...
                            ?>
                                ...
                                <div class="input-group input-group-outline mb-3"> 
                                <label class="form-label">To</label>
                                <select type="text" name="tto_02" class="form-control">
                                <option> </option>";
            ...
            ?>
                            ...
                            ?>
                                ...
                                <div class="input-group input-group-outline mb-3">
                                <label class="form-label">To</label>
                                <select type="text" name="tto_03" class="form-control">
                                <option> </option>";
            ...
            ?>
                            ...
                            ?>
                                 ...
                                 <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">To</label>
                                  <select type="text" name="tto_04" class="form-control">
                                <option> </option>";
            ...
            ?>
                            ...
                            ?>
                                ...
                                <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">evaluation of work</label>
                                  <input type="text" name="evaluation_of_work" class="form-control">
                                </div>   
                                 <div class="input-group input-group-outline mb-3">
