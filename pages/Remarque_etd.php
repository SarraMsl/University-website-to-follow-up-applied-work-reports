...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Remarque techer</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Remarque techer</h6>
        </nav>
                ...
                <div class="col-md-7 mt-4" style="margin-left:1%;width: 120%;">
                  <div class="card">
                    <div class="card-header pb-0 px-3">
                      <h6 class="mb-0">Remarque techer</h6>
                    </div>
   ...
   include("conn.php");
        ...
        $sql=$conn->query("select * from `remarque` where `Type`='1' ");
