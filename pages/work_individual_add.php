      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> Individual work</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">  Individual work</h6>
        </nav>
...
$var = $_SESSION["user_id"];
        $sql=$conn->query("select * from `work_individual` where `Type`='$var'");
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                          <div class="card card-plain">
                            <div class="card-header">
                              <h4 class="font-weight-bolder">Add Type of Individual work </h4>
                              <p class="mb-0">Enter type of Individual work </p>
                            </div>
                            <div class="card-body">
                              <form role="form" method="post" action="back_individual.php"  enctype="multipart/form-data">
                              ...
                              <div class="input-group input-group-outline mb-3">
                                  <label class="form-label">file of Individual work</label>
                                  <input type="file" name="file" class="form-control">
    
                              </div> 
                                <div class="text-center">
                                  <button type="submit"  value="submits"  name="submits" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"> Add</button>
                                </div>
                              </form>
