                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                      <div class="d-flex flex-column">
                        ...
                        <span class="mb-2 text-xs">Role: <span class="text-dark font-weight-bold ms-sm-2"><?php echo $row['Faculties']; ?></span></span>
                        <span class="mb-2 text-xs">Department: <span class="text-dark ms-sm-2 font-weight-bold"><?php echo $row['Department']; ?></span></span>
                        <span class="mb-2 text-xs">Module: <span class="text-dark ms-sm-2 font-weight-bold"><?php echo $row['Speciality']; ?></span></span>
