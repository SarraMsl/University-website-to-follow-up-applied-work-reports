      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Note Individual</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Note Individual</h6>
        </nav>
...
">
                  <div class="card">
                    <div class="card-header pb-0 px-3">
                      <h6 class="mb-0">Note Individual</h6>
                    </div>
...
include("conn.php");
        ...
        $sql=$conn->query("select * from `note` ");
        while($row=$sql->fetch_array()){
          ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                          <div class="card card-plain">
                            ...
                            <div class="card-body">
                              <form role="form" method="post" action="back_note.php">
                              <div class="input-group input-group-outline mb-3">
                                ...
                                <select type="text" name="tto" class="form-control">
                                <option> </option>";
            ...
            ?>
                            ...
                            ?>
                                ...
                                <div class="text-center">
                                  <button type="submit"  value="submitcJ"  name="submitcJ" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"> Add</button>
                                </div>
                              </form>
