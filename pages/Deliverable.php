      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Deliverable</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Deliverable</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="C:\xampp\htdocs\Nouveau dossier\pages\profile.php" class="nav-link text-body font-weight-bold px-0">
...
Pdf Metting Report : <span class="text-dark ms-sm-2 font-weight-bold">
                ...
                <a href="download.php?file=<?php echo $row['file_of_meeting'] ?>">Download</a><br></span></span>
