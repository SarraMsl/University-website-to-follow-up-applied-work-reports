...
include("conn.php");
  ...
  $sql="select count(id_deliverable) as total from deliverable  WHERE DATE( NOW() ) ";
  $result = $conn->query($sql);
  $values=mysqli_fetch_assoc($result);
...
include("conn.php");
  ...
  $sql="select count(id_Collective_work) as total from Collective_work  WHERE DATE( NOW() ) ";
  $result = $conn->query($sql);
  $values=mysqli_fetch_assoc($result);
...
include("conn.php");
    ...
    $sql="select count(id_work_Individual) as total from work_Individual  WHERE DATE( NOW() ) ";
    $result = $conn->query($sql);
    $values=mysqli_fetch_assoc($result);
...
include("conn.php");
  ...
  $sql="select count(id_link) as total from link  WHERE DATE( NOW() ) ";
  $result = $conn->query($sql);
  $values=mysqli_fetch_assoc($result);
...
include("conn.php");
  ...
  $sql="select count(id_Remarque) as total from remarque WHERE DATE( NOW() ) ";
  $result = $conn->query($sql);
  $values=mysqli_fetch_assoc($result);
  ...
  ?>
                ...
                <div class="text-end pt-1">
                  ...
                  <h4 class="mb-0"><?php echo $num_rowthh;?></h4>
                </div>
              </div>
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
  ...
  <div class="row">
    ...
    include("conn.php");
        ...
        $sql=$conn->query("select * from `deliverable` ");
        while($row=$sql->fetch_array()){
          ?>
...
Pdf Metting Report : <span class="text-dark ms-sm-2 font-weight-bold">
    ...
    include("conn.php");
        ...
        $sql=$conn->query("select * from `work_individual` ");
        while($row=$sql->fetch_array()){
          ?>
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                          <div class="d-flex flex-column">
...
include("conn.php");
        ...
        $sql=$conn->query("select * from `collective_work` ");
        while($row=$sql->fetch_array()){
          ?>
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                        <div class="d-flex flex-column">
...
Pdf Metting Report : <span class="text-dark ms-sm-2 font-weight-bold">
   ...
   include("conn.php");
        ...
        $sql=$conn->query("select * from `link` ");
        while($row=$sql->fetch_array()){
          ?>
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                        <div class="d-flex flex-column">
